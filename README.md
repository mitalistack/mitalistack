...
**Languages**: HTML5 , CSS , JavaScript(ES6) , C++<br>
**Frontend**: React.js, Tailwind CSS, Bootstrap<br>
**Backend**: Node.js , Express.js<br>
**Database**: MongoDB<br>
**Tools & Platforms**: Git, GitHub, VS Code, Postman<br>
**Concepts**: Data Structures & Algorithms, REST APIs, Responsive Web Design<br>
**Other Skills**: Team Collaboration, Problem Solving, Agile Development
